...
class _ActorsByMovie extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isLoadingActors = ref.watch(actorsByMovieProvider.notifier).isLoading;
...
final isFavoriteProvider =
    FutureProvider.family.autoDispose((ref, Movie movie) {
...
class _CustomSliverAppBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isFavoriteFuter = ref.watch(isFavoriteProvider(movie));
